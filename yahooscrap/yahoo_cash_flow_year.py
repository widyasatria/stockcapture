            ...
            for x in result:
                ...
                if all_datas is not None:
                    ...
                    if debug==True:
                        ...
                        logging.info("Panjang rw-expanded " + str(len(txt_tbody)))
                    k=1
                    for txt_labels in txt_tbody:
                        ...
                        for txt_data in row_datas:
                            ...
                            # data disimpan mulai di array no 5, kemudian iterate terus sampai 5+ (panjang kolom-2) karena Kolom TTM di skip
                            # untuk inc_stat_year
