...
def main():
    ...
    logger.info('=================START SCRIPT yahoo_stock_fin_cash_flow_year================= ')
    options = Options()
    ...
    try:
        ...
        if result is not None:      
            for x in result:
                ...
                print('=== Populating Yearly Stock fin cash flow  statement for '+ txt_ticker)
                logger.info('=== Populating Stock fin Cash flow Year statement for '+ txt_ticker)
                            ...
                            for tbl_body_row in tbl_body_rows:
                                ...
                                for col_value in col_values:
                                    ...
                                    if ctr>0:    
                                        ...
                                        cursor.callproc('stock_fin_cash_flow_year_upsert',arg1)
        ...
        logger.info('=================End script yahoo_bal_sheet_year================= ')
