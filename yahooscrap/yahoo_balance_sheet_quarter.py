...
def main():
    ...
    logger.info('=================START SCRIPT yahoo_bal_sheet_quarter================= ')
    options = Options()
    ...
    try:
        ...
        if result is not None:      
            for x in result:
                ...
                print('=== Populating Quarterly balance sheet quarter statement for '+ txt_ticker)
                logger.info('=== Populating Balance Sheet Quarter statement for '+ txt_ticker)
