...
def main():
    ...
    logger.info('=================START SCRIPT yahoo_bal_sheet_year================= ')
    options = Options()
    ...
    try:
        ...
        if result is not None:      
            for x in result:
                ...
                print('=== Populating Yearly balance sheet  statement for '+ txt_ticker)
                logger.info('=== Populating Balance Sheet Year statement for '+ txt_ticker)
